...
utility_text = dbc.Card(
    [
        ...
        dbc.ListGroup(
            [
                make_listgroup_item("text-*-start"),
                make_listgroup_item("text-*-center"),
                make_listgroup_item("text-*-end"),
                make_listgroup_item("text-wrap"),
                make_listgroup_item("text-nowrap"),
                make_listgroup_item("text-break"),
                make_listgroup_item("text-{option}"),
                make_listgroup_item("fs-{size}"),
                make_listgroup_item("fw-{weight}"),
                make_listgroup_item("fst-{style}"),
