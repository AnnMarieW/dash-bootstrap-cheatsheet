...
utility_spacing = dbc.Card(
    [
        ...
        dbc.ListGroup(
            [
                make_listgroup_item("m-*-{option}"),
                make_listgroup_item("mt-*-{option}"),
                make_listgroup_item("me-*-{option}"),
                make_listgroup_item("mb-*-{option}"),
                make_listgroup_item("ms-*-{option}"),
                make_listgroup_item("mx-*-{option}"),
                make_listgroup_item("my-*-{option}"),
                make_listgroup_item("p-*-{option}"),
                make_listgroup_item("pt-*-{option}"),
                make_listgroup_item("pe-*-{option}"),
                make_listgroup_item("pb-*-{option}"),
                make_listgroup_item("ps-*-{option}"),
                make_listgroup_item("px-*-{option}"),
                make_listgroup_item("py-*-{option}"),
                make_listgroup_item("gap-*-{size}"),
            ],
            flush=True,
            className="border-0",
        ),
